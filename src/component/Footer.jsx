  ...
  return (
    <footer className="footer">
      <div className="container footer-container">
        ...
        <AnimateOnScroll className="footer-nav" animation="fade-up" delay={0.1}>
        ...
        <AnimateOnScroll className="footer-social" animation="fade-up" delay={0.2}>
          ...
          <a href="https://x.com/Tersemajesty200" target="_blank" rel="noopener noreferrer" className="social-link">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
        ...
        <AnimateOnScroll className="footer-copyright" animation="fade-up" delay={0.3}>
          © {currentYear} Okeke Chidera. All rights reserved.
        </AnimateOnScroll>
      </div>
    </footer>
  )
